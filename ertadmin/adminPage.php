        ...
        <div class="row">
          <div class="col-lg-12">
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-laptop"></i><a href="adminPage.php">Carousel</a></li>
            </ol>
          </div>
        </div>
		  ...
		  <?php
			...
			';
				...
				while($row = mysqli_fetch_assoc($result)){
					$out .= "<tr class='trID_".$row['home_car_id']."'>
						<td>".$i."</td>
						<td class='td_name'>".$row['home_car_name']."</td>
						<td class='td_val'>".$row['home_car_val']."</td>
						<td class='td_photo'>".$row['home_car_photo']."</td>
						<td class='td_link'>".$row['home_car_link']."</td>
						<td>
						  <div class='btn-group'>
	...
	<div id="addCompModal" class="modal fade" role="dialog">
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<form action="addComponentCarousel.php" method="post">
			  <div class="login-wrap">
				<div class="input-group">
				...
				<div class="input-group">
				  <span class="input-group-addon">Tautan</span>
				  <input type="text" class="form-control" name="comLink" placeholder="Isi dengan tautan lanjutan"/>
				</div>
				<br/>
				<button class="btn btn-primary btn-block" type="submit">Simpan</button>
			  </div>
	...
	<div id="editCompModal" class="modal fade" role="dialog">
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<form action="editComponentCarousel.php" method="post">
			  <div class="login-wrap">
				<div class="input-group">
				  <span class="input-group-addon">Nama Komponen</span>
				...
				<div class="input-group">
				  <span class="input-group-addon">Tautan</span>
				  <input type="text" class="form-control" name="comLink" id="comEditLink" />
				</div>
				<br/>
	...
	<div id="delCompModal" class="modal fade" role="dialog">
	  <div class="modal-dialog modal-confirm">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form action="delComponentCarousel.php" method="post">
	...
	<script>
	   $(document).ready(function(){
			...
			$('.btn_edit').click(function(){
				...
				var link =  $row.find('.td_link').text();
				console.log(rowID+" - "+name+" - "+value+" - "+photo+" - "+link);
				$('#comEditId').val(rowID);
